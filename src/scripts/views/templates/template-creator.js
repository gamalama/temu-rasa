...
const createRestaurantItemTemplate = (restaurant) => `
  <div class="card">
    <div class="card__image">
      <img class="lazyload" src="https://placehold.co/600x400?text=Temu+Rasa" data-src="${CONFIG.BASE_URL}images/medium/${restaurant.pictureId}" alt="${restaurant.name} Photo">
    </div>
